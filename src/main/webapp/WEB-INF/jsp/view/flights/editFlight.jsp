...
<head>
    <title>Edytuj flight</title>
</head>
<div class="container">
    <h1 style="text-align: center;">Edytuj flight: </h1>

    <form:form method="POST" modelAttribute="flight" class="form-horizontal">
    <fieldset>
        ...
        <spring:bind path="airplane">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                ...
                <div class="col-md-4">
                    <form:select path="airplane" items="${airplanes}" class="form-control select" placeholder="airplane" itemLabel="name"/>
                    <br>
