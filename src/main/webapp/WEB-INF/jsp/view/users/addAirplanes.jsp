...
<div class="container">
    <h1 style="text-align: center;"><spring:message code="airplanes.add.title"/></h1>
    ...
    <fieldset>
        ...
        <spring:bind path="name">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <spring:message code="airplanes.name" var="airplaneName"/>
                <label class="col-md-4 control-label" for="name">${airplaneName}</label>

                <div class="col-md-4">
                    <form:input type="text" path="name" class="form-control input-md" placeholder="${airplaneName}"
                                required=""
                                autofocus="true"></form:input>
                    <br>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <button id="singlebutton" name="singlebutton" class="btn btn-lg btn-primary btn-block"><spring:message code="airplanes.add.submit"/></button>
            </div>
        </div>
    </fieldset>
    </form:form>
